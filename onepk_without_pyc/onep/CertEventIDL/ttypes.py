...
class CertificateIDL(object):
    ...
    def write(self, oprot):
        if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
            ...
            return 
        oprot.writeStructBegin('CertificateIDL')
...
class CertPkcs12IDL(object):
    ...
    def write(self, oprot):
        if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
            oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
            return 
        oprot.writeStructBegin('CertPkcs12IDL')
        if self.length != None:
...
class CertKeyIDL(object):
    ...
    def write(self, oprot):
        if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
            oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
            return 
        oprot.writeStructBegin('CertKeyIDL')
        if self.encoding_type != None:
            oprot.writeFieldBegin('encoding_type', TType.I16, 1)
            oprot.writeI16(self.encoding_type)
            oprot.writeFieldEnd()
...
class CertTrustpointInfoIDL(object):
    """
    Attributes:
     - is_pkcs12
     - pkcs12
    ...
    thrift_spec = (None,
     ...
     (2,
      TType.STRUCT,
      'pkcs12',
      (CertPkcs12IDL, CertPkcs12IDL.thrift_spec),
      None),
     (3,
      TType.STRUCT,
      'IDCert',
      (CertificateIDL, CertificateIDL.thrift_spec),
      None),
     (4,
      TType.LIST,
      'caCertList',
      (TType.STRUCT, (CertificateIDL, CertificateIDL.thrift_spec)),
      None),
     (5,
      TType.I16,
      'is_exportable_key',
     ...
     (6,
      TType.STRUCT,
      'key',
      (CertKeyIDL, CertKeyIDL.thrift_spec),
      None))
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.pkcs12 = CertPkcs12IDL()
                    self.pkcs12.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.STRUCT:
                    self.IDCert = CertificateIDL()
    ...
    def write(self, oprot):
        if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
            oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
            return 
        oprot.writeStructBegin('CertTrustpointInfoIDL')
