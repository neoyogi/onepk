...
class ConnectionListener(EventListener):
    """
    This interface represents a listener for receiving connection events. 
    
    The class that is interested in processing a connection event should 
